...
from dataset import medical_dataset, mental_dataset
...
def main(args):
    ...
    filename = f"method_name-{method_name}-dataset-{dataset}-llm-{llm}-flag-{flag}-epoches-{epoches}.npy"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='mental', choices=['mamual', "pcit", "medical", "mental"])
    parser.add_argument('--llm', default='chatgpt', choices=['llama', "mixtral", "chatgpt"])
