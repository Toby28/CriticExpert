...
def main(args):
    ...
    '''
    student_model = RobertaClass(0.1, outclass)
    ...
    filename = f"method_name-{method_name}-dataset-{dataset}-llm-{llm}-flag-{flag}-epoches-{epoches}_dist2.json"
    ...
    # output_model_file = f"distil2.bin"
